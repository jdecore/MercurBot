...
export function EngineStatus() {
  ...
  if (!pdfDoc) {
    return (
      <span className="engine-status" title="Carga un PDF para activar la búsqueda local">
  ...
  if (info.streaming) {
    return (
      <span className="engine-status" role="status" title="La IA está leyendo los fragmentos de tu PDF">
