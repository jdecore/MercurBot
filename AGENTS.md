...
*Última actualización: 2026-09-11 (Fase 15 Mascota personalizable con Blobatar — variante `blobatar` + `MascotCustomizer` + nombre persistido; build ok, +~14 KB) — Contrato vivo de Copixi. Cualquier desviación debe justificarse según §41.*
